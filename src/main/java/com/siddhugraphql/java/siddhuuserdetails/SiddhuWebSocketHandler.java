...
import com.siddhugraphql.java.siddhuuserdetails.util.JsonKit;
import com.siddhugraphql.java.siddhuuserdetails.util.QueryParameters;
...
public class SiddhuWebSocketHandler extends TextWebSocketHandler {

    private static final Logger log = LoggerFactory.getLogger(SiddhuWebSocketHandler.class);

    private final SiddhuGraphqlPublisher graphqlPublisher;
    private final AtomicReference<Subscription> subscriptionRef;

    public SiddhuWebSocketHandler(SiddhuGraphqlPublisher graphqlPublisher) {
